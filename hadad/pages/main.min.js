...
var o2 = {
  ...
  */
  ...
  stickHeader: function stickHeader(instance) {
    $(window).scroll(function () {
      var top = $(document).scrollTop();

      if (top > 150) {
        $("._header").addClass('header--fixed'); // $(".navigation").addClass('navigation--fixed');

        $(".navigation-sticky").addClass('navigation--fixed');
        $("body").addClass('body--fixed');
      } else {
        $("body").removeClass('body--fixed');
        $("._header").removeClass('header--fixed'); // $(".navigation").removeClass('navigation--fixed');

        $(".navigation-sticky").removeClass('navigation--fixed');
      }
    });
  },
  stickHeaderCall: function stickHeaderCall() {
...
(function ($) {
  $.fn.turntable = function (options) {
    ...
    var $listItems = $('ul', this).children(),
        ...
        $turntable = $(this),
        sections = []; // splits container based on
    ...
    function divideContainer(images) {
      ...
      var sectionLength = initialLength / dividend; // creates array of value pairs with min and max ranges
    ...
    var applyClasses = function applyClasses(sections, position) {
...
o2.gPopup = {
  outListener: false,
  open: function open(contentClass, position) {
    this.removeListner();
...
o2.index = {
  ...
  myPhone: function myPhone(field) {
    var $input = $(field).find('input');
    var regex = /^((\+7|7|8)+\([0-9]{3}\)[0-9]{3}\-[0-9]{2}\-[0-9]{2})$/;
